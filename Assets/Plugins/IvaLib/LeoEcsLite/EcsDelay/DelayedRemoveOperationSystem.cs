...
{
    public sealed class DelayedRemoveOperationSystem<T> : IEcsRunSystem where T : struct
    {
        private readonly EcsFilterInject<Inc<DelayedRemove<T>>> _delayedFilter = default;
        ...
        public void Run(IEcsSystems systems)
        {
            foreach (var entity in _delayedFilter.Value)
            {
                ...
                {
                    _delayedComponentPool.Del(targetEntity);
